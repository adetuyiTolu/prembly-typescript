...
export { ClientOptions } from 'prembly';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/prembly',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the prembly MCP server. You will use Code Mode to help the user perform
